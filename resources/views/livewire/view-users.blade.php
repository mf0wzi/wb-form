<div>
    <x-jet-dialog-modal maxWidth="2xl" class="pointer-events-none" wire:model="actionActivation">
        <form>
            <x-slot name="title">
                {{ __('View') }}
            </x-slot>
                                ...
                                <div class="py-10 md:py-10 mb-8">
                                    ...
                                    <div x-show.transition.in="step === 1">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <x-jet-input type="text" wire:model.lazy="arabic_name" id="arabic_name" autocomplete="arabic_name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" readonly disabled/>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <x-jet-input type="text" wire:model.lazy="english_name" id="english_name" autocomplete="english_name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" readonly disabled/>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <select id="gender" wire:model="gender" autocomplete="gender" class="inline-flex justify-center w-full mt-1 rounded-md px-5 py-2 bg-white border border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" readonly disabled>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <x-jet-flatpickr name="birthday" wire:model.lazy="birthday" id="birthday" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" readonly disabled/>
                                            {{--                            <x-jet-date-picker id="birthday" name="birthday" wire:model="birthday" autocomplete="off" hidden_element="hidden_start_date" readonly disabled/>--}}
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <x-jet-input type="text" wire:model.lazy="mobile_number" id="mobile_number" autocomplete="mobile_number" maxlength="9" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" readonly disabled/>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <x-jet-input type="text" wire:model.lazy="kin_mobile_number" id="kin_mobile_number" autocomplete="kin_mobile_number" maxlength="9" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" readonly disabled/>
                                        ...
                                        <div class="mt-4">
                                            <div>
                                                <div class="mb-8">
                                                    ...
                                                    <select id="city" name="city" wire:model="city" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" readonly disabled>
                                                ...
                                                @if(count($districts) > 0)
                                                    <div class="mb-8">
                                                        ...
                                                        <select id="district" name="district" wire:model="district"
                                                                class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" readonly disabled>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <x-jet-textarea id="address" wire:model.lazy="address" class="inline-flex justify-center w-full rounded-md px-5 py-2 bg-white border border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" name="address" readonly disabled>
                                            </x-jet-textarea>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <select id="qualification" wire:model.lazy="qualification" class="inline-flex justify-center w-full rounded-md px-5 py-2 bg-white border border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" name="qualification" readonly disabled>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <x-jet-input type="email" wire:model.lazy="email" id="email" autocomplete="email" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" readonly disabled/>
                                    ...
                                    <div x-show.transition.in="step === 2">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <x-jet-input type="text" wire:model.lazy="com_name" id="com_name" autocomplete="com_name" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" readonly disabled/>
                                        ...
                                        <div class="mt-4">
                                            <div>
                                                <div class="mb-8">
                                                    ...
                                                    <select id="com_city" name="com_city" wire:model="com_city" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" readonly disabled>
                                                        <option value=''>Choose a city</option>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <x-jet-textarea id="com_address" wire:model.lazy="com_address" class="inline-flex justify-center w-full rounded-md px-5 py-2 bg-white border border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" name="com_address" readonly disabled>
                                            </x-jet-textarea>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <x-jet-input type="text" wire:model.lazy="com_number" id="com_number" autocomplete="com_number" maxlength="9" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" readonly disabled/>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <x-jet-input type="text" wire:model.lazy="com_fax" id="com_fax" autocomplete="com_fax" maxlength="6" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" readonly disabled/>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <x-jet-input type="email" wire:model.lazy="com_email" id="com_email" autocomplete="com_email" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" readonly disabled/>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <select id="com_sector" wire:model.lazy="com_sector" class="inline-flex justify-center w-full rounded-md px-5 py-2 bg-white border border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" name="com_sector" readonly disabled>
                                        ...
                                        @if($com_sector == 'others')
                                            <div class="mt-4">
                                                ...
                                                <x-jet-input type="text" wire:model.lazy="com_other_sector" id="com_other_sector" autocomplete="com_other_sector" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" readonly disabled/>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <select id="com_area" wire:model.lazy="com_area" class="inline-flex justify-center w-full rounded-md px-5 py-2 bg-white border border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" name="com_area" readonly disabled>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <x-jet-textarea id="com_activities" wire:model.lazy="com_activities" class="inline-flex justify-center w-full rounded-md px-5 py-2 bg-white border border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" name="com_activities" readonly disabled>
                                            </x-jet-textarea>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <select id="com_size" wire:model.lazy="com_size" class="inline-flex justify-center w-full rounded-md px-5 py-2 bg-white border border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" name="com_size" readonly disabled>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <x-jet-flatpickr name="com_esta_date" wire:model.lazy="com_esta_date" id="com_esta_date" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" readonly disabled/>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <x-jet-input type="number" wire:model.lazy="com_male_per_emp_no" id="com_male_per_emp_no" autocomplete="com_male_per_emp_no" maxlength="4" max="9999" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" readonly disabled/>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <x-jet-input type="number" wire:model.lazy="com_female_per_emp_no" id="com_female_per_emp_no" autocomplete="com_female_per_emp_no" maxlength="4" max="9999" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" readonly disabled/>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <x-jet-input type="text" wire:model.lazy="com_per_emp_avg_salary" id="com_per_emp_avg_salary" autocomplete="com_per_emp_avg_salary" maxlength="12" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" readonly disabled/>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <x-jet-input type="number" wire:model.lazy="com_male_tem_emp_no" id="com_male_tem_emp_no" autocomplete="com_male_tem_emp_no" maxlength="4" max="9999" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" readonly disabled/>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <x-jet-input type="number" wire:model.lazy="com_female_tem_emp_no" id="com_female_tem_emp_no" autocomplete="com_female_tem_emp_no" maxlength="4" max="9999" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" readonly disabled/>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <x-jet-input type="text" wire:model.lazy="com_tem_emp_avg_salary" id="com_tem_emp_avg_salary" autocomplete="com_tem_emp_avg_salary" maxlength="12" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" readonly disabled/>
                                    ...
                                    <div x-show.transition.in="step === 3">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <select id="com_bank_account" wire:model="com_bank_account" class="inline-flex justify-center w-full rounded-md px-5 py-2 bg-white border border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" name="com_bank_account" readonly disabled>
                                        ...
                                        @if($com_bank_account == 'others')
                                            <div class="mt-4">
                                                ...
                                                <x-jet-input type="text" wire:model="com_other_bank_account" id="com_other_bank_account" autocomplete="com_other_bank_account" maxlength="12" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" readonly disabled/>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <select id="com_permit" wire:model="com_permit" class="inline-flex justify-center w-full rounded-md px-5 py-2 bg-white border border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" name="com_permit" readonly disabled>
                                        ...
                                        @if($com_permit == 'others')
                                            <div class="mt-4">
                                                ...
                                                <x-jet-input type="text" wire:model.lazy="com_permit_other" id="com_permit_other" autocomplete="com_permit_other" maxlength="12" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" readonly disabled/>
                                            ...
                                            <div class="mt-4">
                                                ...
                                                <x-jet-flatpickr name="com_permit_renewal_date" wire:model.lazy="com_permit_renewal_date" id="com_permit_renewal_date" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" readonly disabled/>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <select id="com_archive" wire:model.lazy="com_archive" class="inline-flex justify-center w-full rounded-md px-5 py-2 bg-white border border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" name="com_archive" readonly disabled>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <x-jet-input type="number" wire:model.lazy="com_clients_no_2020" id="com_clients_no_2020" autocomplete="com_clients_no_2020" maxlength="5" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" readonly disabled/>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <x-jet-input type="number" wire:model.lazy="com_supplier_no" id="com_supplier_no" autocomplete="com_supplier_no" maxlength="5" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" readonly disabled/>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <x-jet-input type="number" wire:model.lazy="com_firm_no" id="com_firm_no" autocomplete="com_firm_no" maxlength="5" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" readonly disabled/>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <select id="com_external_audit" wire:model="com_external_audit" class="inline-flex justify-center w-full rounded-md px-5 py-2 bg-white border border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" name="com_external_audit" readonly disabled>
                                        ...
                                        @if($com_external_audit == 'yes')
                                            <div class="mt-4">
                                                ...
                                                <select id="com_external_audit_yes" wire:model="com_external_audit_yes" class="inline-flex justify-center w-full rounded-md px-5 py-2 bg-white border border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" name="com_external_audit_yes" readonly disabled>
                                                    <option value="">اختر الإجابة</option>
                                            ...
                                            <div class="mt-4">
                                                ...
                                                <x-jet-flatpickr name="com_last_external_audit" wire:model="com_last_external_audit" id="com_last_external_audit" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" readonly disabled/>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <select id="com_partner" wire:model="com_partner" class="inline-flex justify-center w-full rounded-md px-5 py-2 bg-white border border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" name="com_partner" readonly disabled>
                                                <option value="">اختر الإجابة</option>
                                                <option value="yes">نعم</option>
                                                <option value="no">لا</option>
                                            </select>
                                        ...
                                        @if($com_your_job_description == 'others')
                                            <div class="mt-4">
                                                ...
                                                <x-jet-input type="text" wire:model.lazy="com_your_job_description_other" id="com_your_job_description_other" autocomplete="com_your_job_description_other" maxlength="12" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" readonly disabled/>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <select id="com_financial_source" wire:model="com_financial_source" class="inline-flex justify-center w-full rounded-md px-5 py-2 bg-white border border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" name="com_financial_source" readonly disabled>
                                                <option value="">اختر الإجابة</option>
                                                <option value="yes">نعم</option>
                                                <option value="no">لا</option>
                                            </select>
                                        ...
                                        @if($com_financial_source == 'yes')
                                            <div class="mt-4">
                                                ...
                                                <x-jet-input type="number" wire:model="com_financial_source_amount" id="com_financial_source_amount" autocomplete="com_financial_source_amount" maxlength="12" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" readonly disabled/>
                                    ...
                                    <div x-show.transition.in="step === 4">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <select id="com_how_do_you_know" wire:model="com_how_do_you_know" class="inline-flex justify-center w-full rounded-md px-5 py-2 bg-white border border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm" name="com_how_do_you_know" readonly disabled>
                                                <option value="">اختر الإجابة</option>
                                        ...
                                        @if($com_how_do_you_know == 'others')
                                            <div class="mt-4">
                                                ...
                                                <x-jet-input type="text" wire:model.lazy="com_how_do_you_know_other" id="com_how_do_you_know_other" autocomplete="com_how_do_you_know_other" maxlength="12" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" readonly disabled/>
                                    ...
                                    <div x-show.transition.in="step === 5">
                                        ...
                                        <div class="mt-4">
                                            <livewire:user-file-uploads :user_id="$user_id" :uuid="$uuid"/>
                                        </div>
                                    </div>
                                </div>
                                <!-- / Step Content -->
